...
export const ActionCarousel = () => {
  ...
  // 모달 관련 변수
   ...
   const fetchMoviesGenre = async () => {
     const responseAction = await getMoviesGenre(1,'fc84777a-d713-4539-a5b9-8c24f0c85b99');
...
export const CrimeCarousel = () => {
  ...
  // 모달 관련 변수
   ...
   const fetchMoviesGenre = async () => {
     const responseCrime = await getMoviesGenre(1,'801c5056-0479-415c-b205-9daecad91b0e');
 ...
 export const RomanceCarousel = () => {
  ...
  // 모달 관련 변수
   ...
   const fetchMoviesGenre = async () => {
     const responseRomance = await getMoviesGenre(1,'73fa7e1d-0e3e-4506-9432-21c29faa8dd7');
